...
| [Prompt Optimizer](https://github.com/yuqanggao/hermes-prompt-optimizer) | One-click prompt optimization plugin that converts casual prompts into structured execution prompts using LLM, with fallback to static templates. | [@yuqanggao](https://github.com/yuqanggao) |
